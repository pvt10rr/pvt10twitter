...
namespace Rapid_Reporter
{
    public class TwitterAddon
    {
        ...
        public static void PostOnTwitter()
        {
            ...
            string twitterPost = "[Reporter: " + tempTester + "] " + tempNote + " #" + tempNoteTypes[tempType] + " #" + TwitterAddon.hashCode;
            ...
            if (twitterPost.Length > 140)
            {
                ...
                twitterPost = "[Reporter: " + tempTester + "] " + twitterNote + " #" + tempNoteTypes[tempType] + " #" + TwitterAddon.hashCode;
            }
        ...
        public static void PostCharterOnTwitter()
        {
            // What's going to show on Twitter
            string twitterCharterPost = "[Reporter: " + tempTester + "] " + tempCharter + " #Charter" + " #" + TwitterAddon.hashCode;

            string twitterCharterTrunced;
            int twitterCharterLength;
            int twitterCharterNumberOfCharsToRemove;

            if (twitterCharterPost.Length > 140)
            {
                // How many characters to remove.
                twitterCharterNumberOfCharsToRemove = twitterCharterPost.Length - 140;
                // On which character to start removing.
                twitterCharterLength = tempCharter.Length - twitterCharterNumberOfCharsToRemove;
                // Removes the characters
                twitterCharterTrunced = tempCharter.Substring(0, twitterCharterLength);
                // What's going to show on Twitter if 'charter' is too long and truncated.
                twitterCharterPost = "[Reporter: " + tempTester + "] " + twitterCharterTrunced + " #Charter" + " #" + TwitterAddon.hashCode;
            }

            // Posts on Twitter.
            TwitterResponse<TwitterStatus> tweetResponse = TwitterStatus.Update(TwitterAddon.tokens, twitterCharterPost);
        }
    }
}
