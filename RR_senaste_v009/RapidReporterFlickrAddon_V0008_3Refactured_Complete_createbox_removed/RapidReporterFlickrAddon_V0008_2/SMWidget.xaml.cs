...
namespace Rapid_Reporter
{
    ...
    public partial class SMWidget : Window
    {
        ...
        sessionStartingStage currentStage = sessionStartingStage.tester;
        ...
        private void NoteContent_KeyUp(object sender, System.Windows.Input.KeyEventArgs e)
        {
            ...
            else if (e.Key == Key.Enter)
            {
                ...
                if (e.Key == Key.Enter && NoteContent.Text.Trim().Length != 0)
                {
                    ...
                    if (currentStage == sessionStartingStage.tester)
                    {
      ...
      //      if (edit) this.WindowState = System.Windows.WindowState.Minimized;          // <--\
            ...
            if (SMWidget.ToggleUpload2 == true)
            {
                ...
                ToggleUploadIcon.Source = new BitmapImage(new Uri("ToggleUpload_ON.png", UriKind.Relative));
            }
            else
                ToggleUploadIcon.Source = new BitmapImage(new Uri("ToggleUpload_OFF.png", UriKind.Relative));
        ...
        private void NoteType_TextChanged(object sender, System.Windows.Controls.TextChangedEventArgs e)
        {

        }

        private void timeralarm_ImageFailed(object sender, ExceptionRoutedEventArgs e)
        {
